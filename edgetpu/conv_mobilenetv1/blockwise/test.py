...
def MobileNet(input_shape=None,
  ...
  for i in range(i_64):
      x = _conv_block(x, 64, block_id=1+i*100)

  x = _conv_block(
      x, 128, strides=(2, 2), block_id=2)

  for i in range(i_128):
      x = _conv_block(x, 128, block_id=3+i*100)
  ...
  for i in range(i_256):
      x = _conv_block(x, 256, block_id=5+i*100)
  ...
  for i in range(i_512):
      x = _conv_block(x, 512, block_id=11+i*100)

  x = _conv_block(
      x, 1024, strides=(2, 2), block_id=12)
  
  for i in range(i_1024):
      x = _conv_block(x, 1024, block_id=13+i*100)
